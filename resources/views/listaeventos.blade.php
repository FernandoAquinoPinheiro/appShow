...
<h1 class="text-center" >Esta é a página do Lista Evento</h1>
        ...
        <div class="col-md-6">
            <form method="POST" action="">
                ...
                <div class="mb-3 text-center">
                    <label for="inputEvento" class="form-label fw-bolder">Digite o evento</label>
                    <input type="text" class="form-control" id="inputEvento" name="evento" required>
                </div>
                <div class="mb-3 text-center">
